...
public class SQLiteParser extends Parser {
	...
	public static final int
		SPACES=192, SCOL=1, MINUS=9, WITHOUT_=150, MULTILINE_COMMENT=191, INITIALLY_=86, 
		CHECK_=44, TIES_=181, KEY_=95, NOT_=102, FOLLOWING_=158, ASC_=34, ATTACH_=35, 
		DESC_=60, GROUP_=78, CUME_DIST_=159, FILTER_=178, NTILE_=165, DENSE_RANK_=160, 
		JOIN_=94, CURRENT_TIME_=53, NATURAL_=100, FOREIGN_=74, SELECT_=130, FIRST_=176, 
		HAVING_=79, TRUE_=172, ON_=107, UPDATE_=141, EXCLUDE_=180, ALTER_=30, 
		PRECEDING_=155, AS_=33, EXCEPT_=68, DIV=12, LAST_VALUE_=162, STAR=7, IS_=92, 
		RECURSIVE_=116, MATCH_=99, BEGIN_=38, SET_=131, ESCAPE_=67, VIEW_=145, 
		DETACH_=61, OVER_=152, WHEN_=147, RELEASE_=120, IMMEDIATE_=82, LT_EQ=19, 
		FALSE_=173, AUTOINCREMENT_=36, CONFLICT_=48, RETURNING_=124, EQ=22, OFFSET_=106, 
		CONSTRAINT_=49, COLUMN_=46, DROP_=63, REPLACE_=122, WITH_=149, NOT_EQ1=23, 
		NOT_EQ2=24, PERCENT_RANK_=166, NO_=101, CROSS_=51, INSTEAD_=89, LAST_=177, 
		OUTER_=110, REINDEX_=119, LEAD_=163, PIPE2=11, CAST_=43, AFTER_=28, VIRTUAL_=146, 
		UNEXPECTED_CHAR=193, DATABASE_=55, UNBOUNDED_=156, CURRENT_=157, NTH_VALUE_=164, 
		IDENTIFIER=185, PLAN_=111, OR_=108, ALL_=29, CASE_=42, MOD=13, IF_=80, 
		GT2=15, TEMPORARY_=134, BY_=40, UNION_=139, GT=20, CLOSE_PAR=4, INDEXED_=85, 
		WHERE_=148, FIRST_VALUE_=151, FOR_=73, CURRENT_TIMESTAMP_=54, FAIL_=72, 
		CREATE_=50, EXCLUSIVE_=69, RENAME_=121, ROWS_=128, LAG_=161, INDEX_=84, 
		RANK_=167, UNIQUE_=140, INTERSECT_=90, RESTRICT_=123, DELETE_=59, NUMERIC_LITERAL=186, 
		THEN_=135, END_=66, ANALYZE_=31, OTHERS_=182, DOT=2, BETWEEN_=39, GT_EQ=21, 
		DO_=183, PRAGMA_=112, ALWAYS_=170, GROUPS_=179, TO_=136, BIND_PARAMETER=187, 
		RANGE_=154, NOTHING_=184, ASSIGN=6, SAVEPOINT_=129, VACUUM_=143, DEFAULT_=56, 
		DEFERRABLE_=57, WINDOW_=174, DEFERRED_=58, COMMA=5, ACTION_=26, STORED_=171, 
		OF_=105, DISTINCT_=62, ISNULL_=93, LEFT_=96, COMMIT_=47, TABLE_=132, ORDER_=109, 
		PARTITION_=153, LT=18, PIPE=17, REFERENCES_=117, EACH_=64, NOTNULL_=103, 
		AND_=32, CASCADE_=41, AMP=16, OPEN_PAR=3, LT2=14, CURRENT_DATE_=52, RAISE_=115, 
		QUERY_=114, FULL_=76, INSERT_=88, ELSE_=65, PRIMARY_=113, PLUS=8, ROW_=127, 
		USING_=142, ROLLBACK_=126, NULL_=104, TEMP_=133, EXPLAIN_=71, SINGLE_LINE_COMMENT=190, 
		INTO_=91, BLOB_LITERAL=189, NULLS_=175, BEFORE_=37, IN_=83, ADD_=27, COLLATE_=45, 
		VALUES_=144, EXISTS_=70, INNER_=87, GLOB_=77, REGEXP_=118, RIGHT_=125, 
		IGNORE_=81, GENERATED_=169, FROM_=75, LIKE_=97, TRANSACTION_=137, TILDE=10, 
		TRIGGER_=138, STRING_LITERAL=188, ROW_NUMBER_=168, ABORT_=25, LIMIT_=98;
	public static final String[] tokenNames = {
		...
		"'OTHERS'", "'DO'", "'NOTHING'", "IDENTIFIER", "NUMERIC_LITERAL", "BIND_PARAMETER", 
	...
	public final Sql_stmtContext sql_stmt() throws RecognitionException {
		...
		try {
			...
			if (_la==EXPLAIN_) {
				{
				setState(258); match(EXPLAIN_);
				setState(261);
				_la = _input.LA(1);
				if (_la==QUERY_) {
					{
					setState(259); match(QUERY_);
					setState(260); match(PLAN_);
					}
				}
			...
			case 1:
				{
				setState(265); alter_table_stmt();
				}
				break;
			case 2:
				{
				setState(266); analyze_stmt();
				}
				break;
			case 3:
				{
				setState(267); attach_stmt();
				}
				break;
			case 4:
				{
				setState(268); begin_stmt();
				}
				break;
			case 5:
				{
				setState(269); commit_stmt();
				}
				break;
			case 6:
				{
				setState(270); create_index_stmt();
				}
				break;
			case 7:
				{
				setState(271); create_table_stmt();
				}
				break;
			case 8:
				{
				setState(272); create_trigger_stmt();
				}
				break;
			case 9:
				{
				setState(273); create_view_stmt();
				}
				break;
			case 10:
				{
				setState(274); create_virtual_table_stmt();
				}
				break;
			case 11:
				{
				setState(275); delete_stmt();
				}
				break;
			case 12:
				{
				setState(276); delete_stmt_limited();
				}
				break;
			case 13:
				{
				setState(277); detach_stmt();
				}
				break;
			case 14:
				{
				setState(278); drop_stmt();
				}
				break;
			case 15:
				{
				setState(279); insert_stmt();
				}
				break;
			case 16:
				{
				setState(280); pragma_stmt();
				}
				break;
			case 17:
				{
				setState(281); reindex_stmt();
				}
				break;
			case 18:
				{
				setState(282); release_stmt();
				}
				break;
			case 19:
				{
				setState(283); rollback_stmt();
				}
				break;
			case 20:
				{
				setState(284); savepoint_stmt();
				}
				break;
			case 21:
				{
				setState(285); select_stmt();
				}
				break;
			case 22:
				{
				setState(286); update_stmt();
				}
				break;
			case 23:
				{
				setState(287); update_stmt_limited();
				}
				break;
			case 24:
				{
				setState(288); vacuum_stmt();
				}
				break;
			}
			}
	...
	public final Alter_table_stmtContext alter_table_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(291); match(ALTER_);
			setState(292); match(TABLE_);
			setState(296);
			switch ( getInterpreter().adaptivePredict(_input,8,_ctx) ) {
			case 1:
				{
				setState(293); schema_name();
				setState(294); match(DOT);
				}
				break;
			}
			setState(298); table_name();
			setState(321);
			switch (_input.LA(1)) {
			case RENAME_:
				{
				setState(299); match(RENAME_);
				setState(309);
				switch ( getInterpreter().adaptivePredict(_input,10,_ctx) ) {
				case 1:
					{
					setState(300); match(TO_);
					setState(301); ((Alter_table_stmtContext)_localctx).new_table_name = table_name();
					}
					break;
				case 2:
					{
					...
					case 1:
						{
						setState(302); match(COLUMN_);
						}
						break;
					}
					setState(305); ((Alter_table_stmtContext)_localctx).old_column_name = column_name();
					setState(306); match(TO_);
					setState(307); ((Alter_table_stmtContext)_localctx).new_column_name = column_name();
					}
					break;
				}
				}
			...
			case ADD_:
				{
				setState(311); match(ADD_);
				setState(313);
				switch ( getInterpreter().adaptivePredict(_input,11,_ctx) ) {
				case 1:
					{
					setState(312); match(COLUMN_);
					}
					break;
				}
				setState(315); column_def();
				}
				break;
			case DROP_:
				{
				setState(316); match(DROP_);
				setState(318);
				switch ( getInterpreter().adaptivePredict(_input,12,_ctx) ) {
				case 1:
					{
					setState(317); match(COLUMN_);
					}
					break;
				}
	...
	public final Analyze_stmtContext analyze_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(323); match(ANALYZE_);
			setState(331);
			switch ( getInterpreter().adaptivePredict(_input,15,_ctx) ) {
			case 1:
				{
				setState(324); schema_name();
				}
				break;
			case 2:
				{
				...
				case 1:
					{
					setState(325); schema_name();
					setState(326); match(DOT);
					}
					break;
				}
				setState(330); table_or_index_name();
				}
				break;
			}
			}
	...
	public final Attach_stmtContext attach_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(333); match(ATTACH_);
			setState(335);
			switch ( getInterpreter().adaptivePredict(_input,16,_ctx) ) {
			case 1:
				{
				setState(334); match(DATABASE_);
				}
				break;
			}
			setState(337); expr(0);
			setState(338); match(AS_);
			setState(339); schema_name();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Begin_stmtContext begin_stmt() throws RecognitionException {
		...
		try {
			...
			if (_la==TRANSACTION_) {
				{
				setState(345); match(TRANSACTION_);
				setState(347);
				switch ( getInterpreter().adaptivePredict(_input,18,_ctx) ) {
				case 1:
					{
					setState(346); transaction_name();
					}
					break;
				}
				}
	...
	public final Commit_stmtContext commit_stmt() throws RecognitionException {
		...
		try {
			...
			if (_la==TRANSACTION_) {
				{
				setState(352); match(TRANSACTION_);
				}
			}
	...
	public final Rollback_stmtContext rollback_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(355); match(ROLLBACK_);
			setState(357);
			_la = _input.LA(1);
			if (_la==TRANSACTION_) {
				{
				setState(356); match(TRANSACTION_);
				}
			}
			...
			if (_la==TO_) {
				{
				setState(359); match(TO_);
				setState(361);
				switch ( getInterpreter().adaptivePredict(_input,22,_ctx) ) {
				case 1:
					{
					setState(360); match(SAVEPOINT_);
					}
					break;
				}
				setState(363); savepoint_name();
				}
			}
	...
	public final Savepoint_stmtContext savepoint_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(366); match(SAVEPOINT_);
			setState(367); savepoint_name();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Release_stmtContext release_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(369); match(RELEASE_);
			setState(371);
			switch ( getInterpreter().adaptivePredict(_input,24,_ctx) ) {
			case 1:
				{
				setState(370); match(SAVEPOINT_);
				}
				break;
			}
			setState(373); savepoint_name();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Create_index_stmtContext create_index_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(375); match(CREATE_);
			setState(377);
			_la = _input.LA(1);
			if (_la==UNIQUE_) {
				{
				setState(376); match(UNIQUE_);
				}
			}

			setState(379); match(INDEX_);
			setState(383);
			switch ( getInterpreter().adaptivePredict(_input,26,_ctx) ) {
			case 1:
				{
				setState(380); match(IF_);
				setState(381); match(NOT_);
				setState(382); match(EXISTS_);
				}
				break;
			}
			setState(388);
			...
			case 1:
				{
				setState(385); schema_name();
				setState(386); match(DOT);
				}
				break;
			}
			setState(390); index_name();
			setState(391); match(ON_);
			setState(392); table_name();
			setState(393); match(OPEN_PAR);
			setState(394); indexed_column();
			setState(399);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
	...
	public final Indexed_columnContext indexed_column() throws RecognitionException {
		...
		try {
			...
			if (_la==COLLATE_) {
				{
				setState(411); match(COLLATE_);
				setState(412); collation_name();
				}
			}
	...
	public final Create_table_stmtContext create_table_stmt() throws RecognitionException {
		...
		try {
			...
			setState(422); match(TABLE_);
			setState(426);
			switch ( getInterpreter().adaptivePredict(_input,34,_ctx) ) {
			case 1:
				{
				setState(423); match(IF_);
				setState(424); match(NOT_);
				setState(425); match(EXISTS_);
				}
				break;
			}
			setState(431);
			...
			case 1:
				{
				setState(428); schema_name();
				setState(429); match(DOT);
				}
				break;
			}
			setState(433); table_name();
			setState(457);
			switch (_input.LA(1)) {
			case OPEN_PAR:
				{
				setState(434); match(OPEN_PAR);
				setState(435); column_def();
				setState(440);
				_errHandler.sync(this);
				...
				if (_la==WITHOUT_) {
					{
					setState(451); match(WITHOUT_);
					setState(452); ((Create_table_stmtContext)_localctx).row_ROW_ID = match(IDENTIFIER);
					}
				}
			...
			case AS_:
				{
				setState(455); match(AS_);
				setState(456); select_stmt();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Column_defContext column_def() throws RecognitionException {
		...
		try {
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << AS_) | (1L << CHECK_) | (1L << COLLATE_) | (1L << CONSTRAINT_) | (1L << DEFAULT_))) != 0) || ((((_la - 102)) & ~0x3f) == 0 && ((1L << (_la - 102)) & ((1L << (NOT_ - 102)) | (1L << (NULL_ - 102)) | (1L << (PRIMARY_ - 102)) | (1L << (REFERENCES_ - 102)) | (1L << (UNIQUE_ - 102)))) != 0) || _la==GENERATED_) {
				{
				{
				setState(463); column_constraint();
				}
				}
				setState(468);
				_errHandler.sync(this);
	...
	public final Type_nameContext type_name() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(474); match(OPEN_PAR);
				setState(475); signed_number();
				setState(476); match(CLOSE_PAR);
				}
				break;
			case 2:
				{
				setState(478); match(OPEN_PAR);
				setState(479); signed_number();
				setState(480); match(COMMA);
				setState(481); signed_number();
				setState(482); match(CLOSE_PAR);
				}
				break;
			}
			}
	...
	public final Column_constraintContext column_constraint() throws RecognitionException {
		...
		try {
			...
			if (_la==CONSTRAINT_) {
				{
				setState(486); match(CONSTRAINT_);
				setState(487); name();
				}
			}
			...
			case PRIMARY_:
				{
				{
				setState(490); match(PRIMARY_);
				setState(491); match(KEY_);
				setState(493);
				_la = _input.LA(1);
				if (_la==ASC_ || _la==DESC_) {
					{
					setState(492); asc_desc();
					}
				}
				...
				if (_la==AUTOINCREMENT_) {
					{
					setState(498); match(AUTOINCREMENT_);
					}
				}
			...
			case UNIQUE_:
				...
				case NULL_:
					...
					if (_la==NOT_) {
						{
						setState(501); match(NOT_);
						}
					}

					setState(504); match(NULL_);
					}
					break;
				case UNIQUE_:
					{
					setState(505); match(UNIQUE_);
					}
					break;
				default:
					throw new NoViableAltException(this);
			...
			case CHECK_:
				{
				setState(511); match(CHECK_);
				setState(512); match(OPEN_PAR);
				setState(513); expr(0);
				setState(514); match(CLOSE_PAR);
				}
				break;
			case DEFAULT_:
				{
				setState(516); match(DEFAULT_);
				setState(523);
				switch ( getInterpreter().adaptivePredict(_input,51,_ctx) ) {
				case 1:
					{
					setState(517); signed_number();
					}
					break;
				case 2:
					{
					setState(518); literal_value();
					}
					break;
				case 3:
					{
					setState(519); match(OPEN_PAR);
					setState(520); expr(0);
			...
			case COLLATE_:
				{
				setState(525); match(COLLATE_);
				setState(526); collation_name();
				}
				break;
			case REFERENCES_:
				{
				setState(527); foreign_key_clause();
				}
				break;
			case AS_:
			case GENERATED_:
				...
				if (_la==GENERATED_) {
					{
					setState(528); match(GENERATED_);
					setState(529); match(ALWAYS_);
					}
				}

				setState(532); match(AS_);
				setState(533); match(OPEN_PAR);
				setState(534); expr(0);
	...
	public final Signed_numberContext signed_number() throws RecognitionException {
		...
		try {
			...
			setState(544); match(NUMERIC_LITERAL);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Table_constraintContext table_constraint() throws RecognitionException {
		...
		try {
			...
			if (_la==CONSTRAINT_) {
				{
				setState(546); match(CONSTRAINT_);
				setState(547); name();
				}
			}
			...
			case UNIQUE_:
				...
				case PRIMARY_:
					{
					setState(550); match(PRIMARY_);
					setState(551); match(KEY_);
					}
					break;
				case UNIQUE_:
					{
					setState(552); match(UNIQUE_);
					}
					break;
				default:
					throw new NoViableAltException(this);
			...
			case FOREIGN_:
				{
				setState(573); match(FOREIGN_);
				setState(574); match(KEY_);
				setState(575); match(OPEN_PAR);
				setState(576); column_name();
				setState(581);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMMA) {
				...
				setState(584); match(CLOSE_PAR);
				setState(585); foreign_key_clause();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Foreign_key_clauseContext foreign_key_clause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(589); match(REFERENCES_);
			setState(590); foreign_table();
			setState(602);
			_la = _input.LA(1);
			if (_la==OPEN_PAR) {
				{
				setState(591); match(OPEN_PAR);
				setState(592); column_name();
				setState(597);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMMA) {
			...
			while (_la==MATCH_ || _la==ON_) {
				...
				case ON_:
					...
					case CASCADE_:
						{
						setState(608); match(CASCADE_);
						}
						break;
					case RESTRICT_:
						{
						setState(609); match(RESTRICT_);
						}
						break;
					case NO_:
						{
						setState(610); match(NO_);
						setState(611); match(ACTION_);
						}
						break;
					default:
						throw new NoViableAltException(this);
			...
			case 1:
				...
				if (_la==NOT_) {
					{
					setState(621); match(NOT_);
					}
				}

				setState(624); match(DEFERRABLE_);
				setState(627);
				_la = _input.LA(1);
				if (_la==INITIALLY_) {
					{
					setState(625); match(INITIALLY_);
					setState(626);
					_la = _input.LA(1);
	...
	public final Conflict_clauseContext conflict_clause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(631); match(ON_);
			setState(632); match(CONFLICT_);
			setState(633);
			_la = _input.LA(1);
	...
	public final Create_trigger_stmtContext create_trigger_stmt() throws RecognitionException {
		...
		try {
			...
			setState(639); match(TRIGGER_);
			setState(643);
			switch ( getInterpreter().adaptivePredict(_input,71,_ctx) ) {
			case 1:
				{
				setState(640); match(IF_);
				setState(641); match(NOT_);
				setState(642); match(EXISTS_);
				}
				break;
			}
			setState(648);
			...
			case 1:
				{
				setState(645); schema_name();
				setState(646); match(DOT);
				}
				break;
			}
			setState(650); trigger_name();
			setState(655);
			switch (_input.LA(1)) {
			case BEFORE_:
				{
				setState(651); match(BEFORE_);
				}
				break;
			case AFTER_:
				{
				setState(652); match(AFTER_);
				}
				break;
			case INSTEAD_:
				{
				setState(653); match(INSTEAD_);
				setState(654); match(OF_);
				}
				break;
			case DELETE_:
			case INSERT_:
			...
			case DELETE_:
				{
				setState(657); match(DELETE_);
				}
				break;
			case INSERT_:
				{
				setState(658); match(INSERT_);
				}
				break;
			case UPDATE_:
				{
				setState(659); match(UPDATE_);
				setState(669);
				_la = _input.LA(1);
				if (_la==OF_) {
					{
					setState(660); match(OF_);
					setState(661); column_name();
					setState(666);
					_errHandler.sync(this);
					_la = _input.LA(1);
					while (_la==COMMA) {
			...
			setState(673); match(ON_);
			setState(674); table_name();
			setState(678);
			_la = _input.LA(1);
			if (_la==FOR_) {
				{
				setState(675); match(FOR_);
				setState(676); match(EACH_);
				setState(677); match(ROW_);
				}
			}
			...
			if (_la==WHEN_) {
				{
				setState(680); match(WHEN_);
				setState(681); expr(0);
				}
			}

			setState(684); match(BEGIN_);
			setState(693); 
			_errHandler.sync(this);
			_la = _input.LA(1);
			do {
				...
				case 1:
					{
					setState(685); update_stmt();
					}
					break;
				case 2:
					{
					setState(686); insert_stmt();
					}
					break;
				case 3:
					{
					setState(687); delete_stmt();
					}
					break;
				case 4:
					{
					setState(688); select_stmt();
					}
					break;
				}
				setState(691); match(SCOL);
				}
				}
				setState(695); 
				_errHandler.sync(this);
	...
	public final Create_view_stmtContext create_view_stmt() throws RecognitionException {
		...
		try {
			...
			setState(703); match(VIEW_);
			setState(707);
			switch ( getInterpreter().adaptivePredict(_input,82,_ctx) ) {
			case 1:
				{
				setState(704); match(IF_);
				setState(705); match(NOT_);
				setState(706); match(EXISTS_);
				}
				break;
			}
			setState(712);
			...
			case 1:
				{
				setState(709); schema_name();
				setState(710); match(DOT);
				}
				break;
			}
			setState(714); view_name();
			setState(726);
			_la = _input.LA(1);
			if (_la==OPEN_PAR) {
				{
				setState(715); match(OPEN_PAR);
				setState(716); column_name();
				setState(721);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMMA) {
			...
			setState(728); match(AS_);
			setState(729); select_stmt();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Create_virtual_table_stmtContext create_virtual_table_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(731); match(CREATE_);
			setState(732); match(VIRTUAL_);
			setState(733); match(TABLE_);
			setState(737);
			switch ( getInterpreter().adaptivePredict(_input,86,_ctx) ) {
			case 1:
				{
				setState(734); match(IF_);
				setState(735); match(NOT_);
				setState(736); match(EXISTS_);
				}
				break;
			}
			setState(742);
			...
			case 1:
				{
				setState(739); schema_name();
				setState(740); match(DOT);
				}
				break;
			}
			setState(744); table_name();
			setState(745); match(USING_);
			setState(746); module_name();
			setState(758);
			_la = _input.LA(1);
			if (_la==OPEN_PAR) {
				{
				setState(747); match(OPEN_PAR);
				setState(748); module_argument();
				setState(753);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMMA) {
	...
	public final With_clauseContext with_clause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(760); match(WITH_);
			setState(762);
			switch ( getInterpreter().adaptivePredict(_input,90,_ctx) ) {
			case 1:
				{
				setState(761); match(RECURSIVE_);
				}
				break;
			}
			setState(764); cte_table_name();
			setState(765); match(AS_);
			setState(766); match(OPEN_PAR);
			setState(767); select_stmt();
			...
			while (_la==COMMA) {
				...
				setState(770); cte_table_name();
				setState(771); match(AS_);
				setState(772); match(OPEN_PAR);
				setState(773); select_stmt();
	...
	public final Cte_table_nameContext cte_table_name() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(781); table_name();
			setState(793);
			_la = _input.LA(1);
			if (_la==OPEN_PAR) {
				{
				setState(782); match(OPEN_PAR);
				setState(783); column_name();
				setState(788);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMMA) {
	...
	public final Recursive_cteContext recursive_cte() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(795); cte_table_name();
			setState(796); match(AS_);
			setState(797); match(OPEN_PAR);
			setState(798); initial_select();
			setState(799); match(UNION_);
			setState(801);
			_la = _input.LA(1);
			if (_la==ALL_) {
				{
				setState(800); match(ALL_);
				}
			}

			setState(803); recursive_select();
			setState(804); match(CLOSE_PAR);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Common_table_expressionContext common_table_expression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(806); table_name();
			setState(818);
			_la = _input.LA(1);
			if (_la==OPEN_PAR) {
				{
				setState(807); match(OPEN_PAR);
				setState(808); column_name();
				setState(813);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMMA) {
			...
			setState(820); match(AS_);
			setState(821); match(OPEN_PAR);
			setState(822); select_stmt();
			setState(823); match(CLOSE_PAR);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Delete_stmtContext delete_stmt() throws RecognitionException {
		...
		try {
			...
			if (_la==WITH_) {
				{
				setState(825); with_clause();
				}
			}

			setState(828); match(DELETE_);
			setState(829); match(FROM_);
			setState(830); qualified_table_name();
			setState(833);
			_la = _input.LA(1);
			if (_la==WHERE_) {
				{
				setState(831); match(WHERE_);
				setState(832); expr(0);
				}
			}
	...
	public final Delete_stmt_limitedContext delete_stmt_limited() throws RecognitionException {
		...
		try {
			...
			if (_la==WITH_) {
				{
				setState(838); with_clause();
				}
			}

			setState(841); match(DELETE_);
			setState(842); match(FROM_);
			setState(843); qualified_table_name();
			setState(846);
			_la = _input.LA(1);
			if (_la==WHERE_) {
				{
				setState(844); match(WHERE_);
				setState(845); expr(0);
				}
			}
			...
			if (_la==LIMIT_ || _la==ORDER_) {
				...
				if (_la==ORDER_) {
					{
					setState(851); order_by_stmt();
					}
				}

				setState(854); limit_stmt();
				}
			}
	...
	public final Detach_stmtContext detach_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(857); match(DETACH_);
			setState(859);
			switch ( getInterpreter().adaptivePredict(_input,105,_ctx) ) {
			case 1:
				{
				setState(858); match(DATABASE_);
				}
				break;
			}
			setState(861); schema_name();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Drop_stmtContext drop_stmt() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(865); match(IF_);
				setState(866); match(EXISTS_);
				}
				break;
			}
			setState(872);
			...
			case 1:
				{
				setState(869); schema_name();
				setState(870); match(DOT);
				}
				break;
			}
			setState(874); any_name();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(877); unary_operator();
				setState(878); expr(21);
				}
				break;
			case 2:
				{
				setState(880); literal_value();
				}
				break;
			case 3:
				{
				setState(881); match(BIND_PARAMETER);
				}
				break;
			case 4:
				{
				...
				case 1:
					...
					case 1:
						{
						setState(882); schema_name();
						setState(883); match(DOT);
						}
						break;
					}
					setState(887); table_name();
					setState(888); match(DOT);
					}
					break;
				}
				setState(892); column_name();
				}
				break;
			case 5:
				{
				setState(893); function_name();
				...
				setState(909); match(CLOSE_PAR);
				setState(911);
				switch ( getInterpreter().adaptivePredict(_input,113,_ctx) ) {
				case 1:
					{
					setState(910); filter_clause();
					}
					break;
				}
				setState(914);
			...
			case 6:
				...
				setState(925); match(CLOSE_PAR);
				}
				break;
			case 7:
				{
				setState(927); match(CAST_);
				setState(928); match(OPEN_PAR);
				setState(929); expr(0);
				setState(930); match(AS_);
				setState(931); type_name();
			...
			case 8:
				...
				if (_la==EXISTS_ || _la==NOT_) {
					...
					if (_la==NOT_) {
						{
						setState(934); match(NOT_);
						}
					}

					setState(937); match(EXISTS_);
					}
				}

				setState(940); match(OPEN_PAR);
				setState(941); select_stmt();
				setState(942); match(CLOSE_PAR);
				}
				break;
			case 9:
				{
				setState(944); match(CASE_);
				setState(946);
				...
				do {
					{
					{
					setState(948); match(WHEN_);
					setState(949); expr(0);
					setState(950); match(THEN_);
					setState(951); expr(0);
					}
					}
					setState(955); 
				...
				if (_la==ELSE_) {
					{
					setState(957); match(ELSE_);
					setState(958); expr(0);
					}
				}

				setState(961); match(END_);
				}
				break;
			case 10:
				{
				setState(963); raise_function();
				}
				break;
			}
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(967); match(PIPE2);
						setState(968); expr(21);
						}
						break;
					case 2:
						{
					...
					case 6:
						...
						case 3:
							{
							setState(984); match(NOT_EQ1);
							}
							break;
						case 4:
							{
							setState(985); match(NOT_EQ2);
							}
							break;
						case 5:
							{
							setState(986); match(IS_);
							}
							break;
						case 6:
							{
							setState(987); match(IS_);
							setState(988); match(NOT_);
							}
							break;
						case 7:
							{
							setState(989); match(IN_);
							}
							break;
						case 8:
							{
							setState(990); match(LIKE_);
							}
							break;
						case 9:
							{
							setState(991); match(GLOB_);
							}
							break;
						case 10:
							{
							setState(992); match(MATCH_);
							}
							break;
						case 11:
							{
							setState(993); match(REGEXP_);
							}
							break;
						}
						setState(996); expr(16);
						}
						break;
					case 7:
						{
						...
						setState(998); match(AND_);
						setState(999); expr(15);
						}
						break;
					case 8:
						{
						...
						setState(1001); match(OR_);
						setState(1002); expr(14);
						}
						break;
					case 9:
						{
						...
						setState(1004); match(IS_);
						setState(1006);
						switch ( getInterpreter().adaptivePredict(_input,123,_ctx) ) {
						case 1:
							{
							setState(1005); match(NOT_);
							}
							break;
						}
						setState(1008); expr(7);
						}
						break;
					case 10:
						{
						...
						if (_la==NOT_) {
							{
							setState(1010); match(NOT_);
							}
						}

						setState(1013); match(BETWEEN_);
						setState(1014); expr(0);
						setState(1015); match(AND_);
						setState(1016); expr(6);
						}
						break;
					case 11:
						{
						...
						setState(1019); match(COLLATE_);
						setState(1020); collation_name();
						}
						break;
					case 12:
						{
						...
						case 1:
							{
							setState(1027); match(ESCAPE_);
							setState(1028); expr(0);
							}
							break;
						}
						}
					...
					case 13:
						...
						case ISNULL_:
							{
							setState(1032); match(ISNULL_);
							}
							break;
						case NOTNULL_:
							{
							setState(1033); match(NOTNULL_);
							}
							break;
						case NOT_:
							{
							setState(1034); match(NOT_);
							setState(1035); match(NULL_);
							}
							break;
						default:
							throw new NoViableAltException(this);
					...
					case 14:
						...
						if (_la==NOT_) {
							{
							setState(1039); match(NOT_);
							}
						}

						setState(1042); match(IN_);
						setState(1081);
						switch ( getInterpreter().adaptivePredict(_input,135,_ctx) ) {
						case 1:
							{
							setState(1043); match(OPEN_PAR);
							setState(1053);
							switch ( getInterpreter().adaptivePredict(_input,130,_ctx) ) {
							case 1:
								{
								setState(1044); select_stmt();
								}
								break;
							case 2:
								{
								setState(1045); expr(0);
								setState(1050);
								_errHandler.sync(this);
								_la = _input.LA(1);
								while (_la==COMMA) {
						...
						case 3:
							...
							case 1:
								{
								setState(1062); schema_name();
								setState(1063); match(DOT);
								}
								break;
							}
							setState(1067); table_function_name();
							setState(1068); match(OPEN_PAR);
							setState(1077);
							_la = _input.LA(1);
	...
	public final Raise_functionContext raise_function() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1088); match(RAISE_);
			setState(1089); match(OPEN_PAR);
			setState(1094);
			switch (_input.LA(1)) {
			case IGNORE_:
				{
				setState(1090); match(IGNORE_);
				}
				break;
			case ABORT_:
			case FAIL_:
			case ROLLBACK_:
				...
				setState(1093); error_message();
				}
				break;
			default:
				throw new NoViableAltException(this);
			}
			setState(1096); match(CLOSE_PAR);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Values_clauseContext values_clause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1111); match(VALUES_);
			setState(1112); value_row();
			setState(1117);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
	...
	public final Insert_stmtContext insert_stmt() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(1123); match(INSERT_);
				}
				break;
			case 2:
				{
				setState(1124); match(REPLACE_);
				}
				break;
			case 3:
				{
				setState(1125); match(INSERT_);
				setState(1126); match(OR_);
				setState(1127);
				_la = _input.LA(1);
				if ( !(_la==ABORT_ || ((((_la - 72)) & ~0x3f) == 0 && ((1L << (_la - 72)) & ((1L << (FAIL_ - 72)) | (1L << (IGNORE_ - 72)) | (1L << (REPLACE_ - 72)) | (1L << (ROLLBACK_ - 72)))) != 0)) ) {
				_errHandler.recoverInline(this);
			...
			setState(1130); match(INTO_);
			setState(1134);
			switch ( getInterpreter().adaptivePredict(_input,143,_ctx) ) {
			case 1:
				{
				setState(1131); schema_name();
				setState(1132); match(DOT);
				}
				break;
			}
			setState(1136); table_name();
			setState(1139);
			_la = _input.LA(1);
			if (_la==AS_) {
				{
				setState(1137); match(AS_);
				setState(1138); table_alias();
				}
			}
			...
			if (_la==OPEN_PAR) {
				{
				setState(1141); match(OPEN_PAR);
				setState(1142); column_name();
				setState(1147);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMMA) {
			...
			case WITH_:
				...
				case 1:
					{
					setState(1154); values_clause();
					}
					break;
				case 2:
					{
					setState(1155); select_stmt();
					}
					break;
				}
				setState(1159);
			...
			case DEFAULT_:
				{
				setState(1161); match(DEFAULT_);
				setState(1162); match(VALUES_);
				}
				break;
			default:
				throw new NoViableAltException(this);
			...
			if (_la==RETURNING_) {
				{
				setState(1165); returning_clause();
				}
			}
	...
	public final Returning_clauseContext returning_clause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1168); match(RETURNING_);
			setState(1169); result_column();
			setState(1174);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
	...
	public final Upsert_clauseContext upsert_clause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1177); match(ON_);
			setState(1178); match(CONFLICT_);
			setState(1193);
			_la = _input.LA(1);
			if (_la==OPEN_PAR) {
				{
				setState(1179); match(OPEN_PAR);
				setState(1180); indexed_column();
				setState(1185);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMMA) {
				...
				setState(1188); match(CLOSE_PAR);
				setState(1191);
				_la = _input.LA(1);
				if (_la==WHERE_) {
					{
					setState(1189); match(WHERE_);
			...
			setState(1195); match(DO_);
			setState(1222);
			switch (_input.LA(1)) {
			case NOTHING_:
				{
				setState(1196); match(NOTHING_);
				}
				break;
			case UPDATE_:
				{
				setState(1197); match(UPDATE_);
				setState(1198); match(SET_);
				{
				setState(1201);
				switch ( getInterpreter().adaptivePredict(_input,155,_ctx) ) {
				case 1:
					{
					setState(1199); column_name();
					}
					break;
				case 2:
					{
					setState(1200); column_name_list();
					}
					break;
				}
				setState(1203); match(ASSIGN);
				...
				while (_la==COMMA) {
					...
					case 2:
						{
						setState(1207); column_name_list();
						}
						break;
					}
					setState(1210); match(ASSIGN);
					setState(1211); expr(0);
					}
					}
					setState(1217);
					_errHandler.sync(this);
				...
				if (_la==WHERE_) {
					{
					setState(1218); match(WHERE_);
					setState(1219); expr(0);
					}
				}
	...
	public final Pragma_stmtContext pragma_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1224); match(PRAGMA_);
			setState(1228);
			switch ( getInterpreter().adaptivePredict(_input,160,_ctx) ) {
			case 1:
				{
				setState(1225); schema_name();
				setState(1226); match(DOT);
				}
				break;
			}
			setState(1230); pragma_name();
			setState(1237);
			switch (_input.LA(1)) {
			case ASSIGN:
				{
				setState(1231); match(ASSIGN);
				setState(1232); pragma_value();
				}
				break;
			case OPEN_PAR:
				{
				setState(1233); match(OPEN_PAR);
				setState(1234); pragma_value();
				setState(1235); match(CLOSE_PAR);
				}
				break;
			case EOF:
			case SCOL:
	...
	public final Pragma_valueContext pragma_value() throws RecognitionException {
		...
		try {
			...
			case 3:
				...
				{
				setState(1241); match(STRING_LITERAL);
				}
				break;
			}
		}
	...
	public final Select_stmtContext select_stmt() throws RecognitionException {
		...
		try {
			...
			if (_la==WITH_) {
				{
				setState(1257); common_table_stmt();
				}
			}

			setState(1260); select_core();
			setState(1266);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					{
					{
					setState(1261); compound_operator();
					setState(1262); select_core();
					}
					} 
				}
				setState(1268);
	...
	public final Join_clauseContext join_clause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1275); table_or_subquery();
			setState(1283);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA || _la==CROSS_ || ((((_la - 87)) & ~0x3f) == 0 && ((1L << (_la - 87)) & ((1L << (INNER_ - 87)) | (1L << (JOIN_ - 87)) | (1L << (LEFT_ - 87)) | (1L << (NATURAL_ - 87)))) != 0)) {
				{
				{
				setState(1276); join_operator();
				setState(1277); table_or_subquery();
				setState(1279);
				switch ( getInterpreter().adaptivePredict(_input,170,_ctx) ) {
				case 1:
					{
					setState(1278); join_constraint();
					}
					break;
				}
				}
	...
	public final Select_coreContext select_core() throws RecognitionException {
		...
		try {
			...
			case SELECT_:
				...
				if (_la==FROM_) {
					{
					setState(1298); match(FROM_);
					setState(1308);
					switch ( getInterpreter().adaptivePredict(_input,175,_ctx) ) {
					case 1:
						{
						setState(1299); table_or_subquery();
						setState(1304);
						_errHandler.sync(this);
						_la = _input.LA(1);
						while (_la==COMMA) {
							...
							setState(1301); table_or_subquery();
							}
							}
							setState(1306);
							_errHandler.sync(this);
				...
				if (_la==WHERE_) {
					{
					setState(1312); match(WHERE_);
					setState(1313); ((Select_coreContext)_localctx).whereExpr = expr(0);
					}
				}
				...
				if (_la==GROUP_) {
					{
					setState(1316); match(GROUP_);
					setState(1317); match(BY_);
					setState(1318); ((Select_coreContext)_localctx).expr = expr(0);
					...
					while (_la==COMMA) {
						...
						setState(1320); ((Select_coreContext)_localctx).expr = expr(0);
						((Select_coreContext)_localctx).groupByExpr.add(((Select_coreContext)_localctx).expr);
						}
						}
						setState(1325);
					...
					if (_la==HAVING_) {
						{
						setState(1326); match(HAVING_);
						setState(1327); ((Select_coreContext)_localctx).havingExpr = expr(0);
						}
					}
				...
				if (_la==WINDOW_) {
					{
					setState(1332); match(WINDOW_);
					setState(1333); window_name();
					setState(1334); match(AS_);
					setState(1335); window_defn();
					setState(1343);
					_errHandler.sync(this);
					_la = _input.LA(1);
					while (_la==COMMA) {
						...
						setState(1337); window_name();
						setState(1338); match(AS_);
						setState(1339); window_defn();
						}
						}
						setState(1345);
						_errHandler.sync(this);
	...
	public final Simple_select_stmtContext simple_select_stmt() throws RecognitionException {
		...
		try {
			...
			if (_la==WITH_) {
				{
				setState(1353); common_table_stmt();
				}
			}

			setState(1356); select_core();
			setState(1358);
			_la = _input.LA(1);
			if (_la==ORDER_) {
				{
				setState(1357); order_by_stmt();
				}
			}
	...
	public final Compound_select_stmtContext compound_select_stmt() throws RecognitionException {
		...
		try {
			...
			if (_la==WITH_) {
				{
				setState(1363); common_table_stmt();
				}
			}

			setState(1366); select_core();
			setState(1376); 
			_errHandler.sync(this);
			_la = _input.LA(1);
			do {
				...
				case UNION_:
					{
					setState(1367); match(UNION_);
					setState(1369);
					_la = _input.LA(1);
					if (_la==ALL_) {
						{
						setState(1368); match(ALL_);
						}
					}
				...
				case INTERSECT_:
					{
					setState(1371); match(INTERSECT_);
					}
					break;
				case EXCEPT_:
					{
					setState(1372); match(EXCEPT_);
					}
					break;
				default:
					throw new NoViableAltException(this);
				}
				setState(1375); select_core();
				}
				}
				setState(1378); 
				_errHandler.sync(this);
	...
	public final Table_or_subqueryContext table_or_subquery() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				case 1:
					{
					setState(1386); schema_name();
					setState(1387); match(DOT);
					}
					break;
				}
				setState(1391); table_name();
				setState(1396);
				...
				case 1:
					...
					case 1:
						{
						setState(1392); match(AS_);
						}
						break;
					}
					setState(1395); table_alias();
					}
					break;
				}
				setState(1403);
				...
				case INDEXED_:
					{
					setState(1398); match(INDEXED_);
					setState(1399); match(BY_);
					setState(1400); index_name();
					}
					break;
				case NOT_:
					{
					setState(1401); match(NOT_);
					setState(1402); match(INDEXED_);
					}
					break;
				case EOF:
				case SCOL:
			...
			case 2:
				...
				case 1:
					{
					setState(1405); schema_name();
					setState(1406); match(DOT);
					}
					break;
				}
				setState(1410); table_function_name();
				setState(1411); match(OPEN_PAR);
				setState(1412); expr(0);
				setState(1417);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMMA) {
				...
				case 1:
					...
					case 1:
						{
						setState(1421); match(AS_);
						}
						break;
					}
					setState(1424); table_alias();
					}
					break;
				}
				}
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(1427); match(OPEN_PAR);
				setState(1437);
				switch ( getInterpreter().adaptivePredict(_input,202,_ctx) ) {
				case 1:
					{
					setState(1428); table_or_subquery();
					setState(1433);
					_errHandler.sync(this);
					_la = _input.LA(1);
					while (_la==COMMA) {
						...
						setState(1430); table_or_subquery();
						}
						}
						setState(1435);
						_errHandler.sync(this);
				...
				case 2:
					{
					setState(1436); join_clause();
					}
					break;
				}
				setState(1439); match(CLOSE_PAR);
				}
				break;
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(1441); match(OPEN_PAR);
				setState(1442); select_stmt();
				setState(1443); match(CLOSE_PAR);
				setState(1448);
				...
				case 1:
					...
					case 1:
						{
						setState(1444); match(AS_);
						}
						break;
					}
					setState(1447); table_alias();
					}
					break;
				}
				}
	...
	public final Result_columnContext result_column() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				setState(1454); match(DOT);
				setState(1455); match(STAR);
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				...
				if (_la==AS_ || _la==IDENTIFIER || _la==STRING_LITERAL) {
					...
					if (_la==AS_) {
						{
						setState(1458); match(AS_);
						}
					}

					setState(1461); column_alias();
					}
				}
	...
	public final Join_operatorContext join_operator() throws RecognitionException {
		...
		try {
			...
			case NATURAL_:
				...
				case LEFT_:
					{
					setState(1470); match(LEFT_);
					setState(1472);
					_la = _input.LA(1);
					if (_la==OUTER_) {
						{
						setState(1471); match(OUTER_);
						}
					}
				...
				case INNER_:
					{
					setState(1474); match(INNER_);
					}
					break;
				case CROSS_:
					{
					setState(1475); match(CROSS_);
					}
					break;
				case JOIN_:
					break;
	...
	public final Join_constraintContext join_constraint() throws RecognitionException {
		...
		try {
			...
			case ON_:
				enterOuterAlt(_localctx, 1);
				{
				setState(1481); match(ON_);
				setState(1482); expr(0);
				}
				break;
			case USING_:
				enterOuterAlt(_localctx, 2);
				{
				setState(1483); match(USING_);
				setState(1484); match(OPEN_PAR);
				setState(1485); column_name();
				setState(1490);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMMA) {
	...
	public final Compound_operatorContext compound_operator() throws RecognitionException {
		...
		try {
			...
			case UNION_:
				enterOuterAlt(_localctx, 1);
				{
				setState(1497); match(UNION_);
				setState(1499);
				_la = _input.LA(1);
				if (_la==ALL_) {
					{
					setState(1498); match(ALL_);
					}
				}
			...
			case INTERSECT_:
				enterOuterAlt(_localctx, 2);
				{
				setState(1501); match(INTERSECT_);
				}
				break;
			case EXCEPT_:
				enterOuterAlt(_localctx, 3);
				{
				setState(1502); match(EXCEPT_);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Update_stmtContext update_stmt() throws RecognitionException {
		...
		try {
			...
			if (_la==WITH_) {
				{
				setState(1505); with_clause();
				}
			}

			setState(1508); match(UPDATE_);
			setState(1511);
			switch ( getInterpreter().adaptivePredict(_input,218,_ctx) ) {
			case 1:
				{
				setState(1509); match(OR_);
				setState(1510);
				_la = _input.LA(1);
				if ( !(_la==ABORT_ || ((((_la - 72)) & ~0x3f) == 0 && ((1L << (_la - 72)) & ((1L << (FAIL_ - 72)) | (1L << (IGNORE_ - 72)) | (1L << (REPLACE_ - 72)) | (1L << (ROLLBACK_ - 72)))) != 0)) ) {
				_errHandler.recoverInline(this);
			...
			setState(1513); qualified_table_name();
			setState(1514); match(SET_);
			setState(1517);
			switch ( getInterpreter().adaptivePredict(_input,219,_ctx) ) {
			case 1:
				{
				setState(1515); column_name();
				}
				break;
			case 2:
				{
				setState(1516); column_name_list();
				}
				break;
			}
			setState(1519); match(ASSIGN);
			setState(1520); expr(0);
			setState(1531);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
				...
				case 2:
					{
					setState(1523); column_name_list();
					}
					break;
				}
				setState(1526); match(ASSIGN);
				setState(1527); expr(0);
				}
				}
				setState(1533);
				_errHandler.sync(this);
			...
			if (_la==FROM_) {
				...
				case 1:
					...
					while (_la==COMMA) {
						...
						setState(1537); table_or_subquery();
						}
						}
						setState(1542);
						_errHandler.sync(this);
			...
			if (_la==WHERE_) {
				{
				setState(1548); match(WHERE_);
				setState(1549); expr(0);
				}
			}
			...
			if (_la==RETURNING_) {
				{
				setState(1552); returning_clause();
				}
			}
	...
	public final Column_name_listContext column_name_list() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1555); match(OPEN_PAR);
			setState(1556); column_name();
			setState(1561);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
	...
	public final Update_stmt_limitedContext update_stmt_limited() throws RecognitionException {
		...
		try {
			...
			if (_la==WITH_) {
				{
				setState(1566); with_clause();
				}
			}

			setState(1569); match(UPDATE_);
			setState(1572);
			switch ( getInterpreter().adaptivePredict(_input,229,_ctx) ) {
			case 1:
				{
				setState(1570); match(OR_);
				setState(1571);
				_la = _input.LA(1);
				if ( !(_la==ABORT_ || ((((_la - 72)) & ~0x3f) == 0 && ((1L << (_la - 72)) & ((1L << (FAIL_ - 72)) | (1L << (IGNORE_ - 72)) | (1L << (REPLACE_ - 72)) | (1L << (ROLLBACK_ - 72)))) != 0)) ) {
				_errHandler.recoverInline(this);
			...
			setState(1574); qualified_table_name();
			setState(1575); match(SET_);
			setState(1578);
			...
			case 2:
				{
				setState(1577); column_name_list();
				}
				break;
			}
			setState(1580); match(ASSIGN);
			setState(1581); expr(0);
			setState(1592);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
				...
				case 1:
					{
					setState(1583); column_name();
					}
					break;
				case 2:
					{
					setState(1584); column_name_list();
					}
					break;
				}
				setState(1587); match(ASSIGN);
				setState(1588); expr(0);
				}
				}
				setState(1594);
				_errHandler.sync(this);
			...
			if (_la==RETURNING_) {
				{
				setState(1599); returning_clause();
				}
			}
			...
			if (_la==LIMIT_ || _la==ORDER_) {
				...
				if (_la==ORDER_) {
					{
					setState(1602); order_by_stmt();
					}
				}

				setState(1605); limit_stmt();
				}
			}
	...
	public final Qualified_table_nameContext qualified_table_name() throws RecognitionException {
		...
		try {
			...
			case INDEXED_:
				{
				setState(1618); match(INDEXED_);
				setState(1619); match(BY_);
				setState(1620); index_name();
				}
				break;
			case NOT_:
				{
				setState(1621); match(NOT_);
				setState(1622); match(INDEXED_);
				}
				break;
			case EOF:
			case SCOL:
	...
	public final Vacuum_stmtContext vacuum_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1625); match(VACUUM_);
			setState(1627);
			switch ( getInterpreter().adaptivePredict(_input,240,_ctx) ) {
			case 1:
				{
				setState(1626); schema_name();
				}
				break;
			}
			setState(1631);
			...
			if (_la==INTO_) {
				{
				setState(1629); match(INTO_);
				setState(1630); filename();
				}
			}
	...
	public final Filter_clauseContext filter_clause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1633); match(FILTER_);
			setState(1634); match(OPEN_PAR);
			setState(1635); match(WHERE_);
			setState(1636); expr(0);
			setState(1637); match(CLOSE_PAR);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Window_defnContext window_defn() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1639); match(OPEN_PAR);
			setState(1641);
			switch ( getInterpreter().adaptivePredict(_input,242,_ctx) ) {
			case 1:
				{
				setState(1640); base_window_name();
				}
				break;
			}
			setState(1653);
			...
			if (_la==PARTITION_) {
				{
				setState(1643); match(PARTITION_);
				setState(1644); match(BY_);
			...
			{
			setState(1655); match(ORDER_);
			setState(1656); match(BY_);
			setState(1657); ordering_term();
			setState(1662);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
	...
	public final Over_clauseContext over_clause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1670); match(OVER_);
			setState(1704);
			switch ( getInterpreter().adaptivePredict(_input,253,_ctx) ) {
			case 1:
				{
				setState(1671); window_name();
				}
				break;
			case 2:
				{
				setState(1672); match(OPEN_PAR);
				setState(1674);
				switch ( getInterpreter().adaptivePredict(_input,247,_ctx) ) {
				case 1:
					{
					setState(1673); base_window_name();
					}
					break;
				}
				setState(1686);
				...
				if (_la==PARTITION_) {
					{
					setState(1676); match(PARTITION_);
					setState(1677); match(BY_);
				...
				if (_la==ORDER_) {
					{
					setState(1688); match(ORDER_);
					setState(1689); match(BY_);
					setState(1690); ordering_term();
					setState(1695);
					_errHandler.sync(this);
					_la = _input.LA(1);
					while (_la==COMMA) {
						{
						{
						setState(1691); match(COMMA);
						setState(1692); ordering_term();
						}
						}
						setState(1697);
						_errHandler.sync(this);
				...
				if (((((_la - 128)) & ~0x3f) == 0 && ((1L << (_la - 128)) & ((1L << (ROWS_ - 128)) | (1L << (RANGE_ - 128)) | (1L << (GROUPS_ - 128)))) != 0)) {
					{
					setState(1700); frame_spec();
					}
				}

				setState(1703); match(CLOSE_PAR);
				}
				break;
			}
			}
	...
	public final Frame_specContext frame_spec() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1706); frame_clause();
			setState(1716);
			_la = _input.LA(1);
			if (_la==EXCLUDE_) {
				{
				setState(1707); match(EXCLUDE_);
				setState(1714);
				switch (_input.LA(1)) {
				case NO_:
					{
					setState(1708); match(NO_);
					setState(1709); match(OTHERS_);
					}
					break;
				case CURRENT_:
					{
					setState(1710); match(CURRENT_);
					setState(1711); match(ROW_);
					}
					break;
				case GROUP_:
					{
					setState(1712); match(GROUP_);
					}
					break;
				case TIES_:
					{
					setState(1713); match(TIES_);
					}
					break;
				default:
					throw new NoViableAltException(this);
	...
	public final Frame_clauseContext frame_clause() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(1719); frame_single();
				}
				break;
			case 2:
				{
				setState(1720); match(BETWEEN_);
				setState(1721); frame_left();
				setState(1722); match(AND_);
				setState(1723); frame_right();
				}
				break;
			}
			}
	...
	public final Simple_function_invocationContext simple_function_invocation() throws RecognitionException {
		...
		try {
			...
			case STAR:
				{
				setState(1737); match(STAR);
				}
				break;
			default:
				throw new NoViableAltException(this);
			}
			setState(1740); match(CLOSE_PAR);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Aggregate_function_invocationContext aggregate_function_invocation() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1742); aggregate_func();
			setState(1743); match(OPEN_PAR);
			setState(1756);
			switch (_input.LA(1)) {
			case OPEN_PAR:
			case PLUS:
			...
			case BLOB_LITERAL:
				...
				while (_la==COMMA) {
					{
					{
					setState(1748); match(COMMA);
					setState(1749); expr(0);
					}
					}
					setState(1754);
					_errHandler.sync(this);
			...
			setState(1758); match(CLOSE_PAR);
			setState(1760);
			_la = _input.LA(1);
			if (_la==FILTER_) {
				{
				setState(1759); filter_clause();
				}
			}
	...
	public final Window_function_invocationContext window_function_invocation() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1762); window_function();
			setState(1763); match(OPEN_PAR);
			setState(1773);
			switch (_input.LA(1)) {
			case OPEN_PAR:
			case PLUS:
			...
			setState(1775); match(CLOSE_PAR);
			setState(1777);
			_la = _input.LA(1);
			if (_la==FILTER_) {
				{
				setState(1776); filter_clause();
				}
			}

			setState(1779); match(OVER_);
			setState(1782);
			switch ( getInterpreter().adaptivePredict(_input,266,_ctx) ) {
			case 1:
				{
				setState(1780); window_defn();
				}
				break;
			case 2:
				{
				setState(1781); window_name();
				}
				break;
			}
			}
	...
	public final Common_table_stmtContext common_table_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1784); match(WITH_);
			setState(1786);
			switch ( getInterpreter().adaptivePredict(_input,267,_ctx) ) {
			case 1:
				{
				setState(1785); match(RECURSIVE_);
				}
				break;
			}
			setState(1788); common_table_expression();
			setState(1793);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
				{
				{
				setState(1789); match(COMMA);
				setState(1790); common_table_expression();
				}
				}
				setState(1795);
				_errHandler.sync(this);
	...
	public final Order_by_stmtContext order_by_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1796); match(ORDER_);
			setState(1797); match(BY_);
			setState(1798); ordering_term();
			setState(1803);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
	...
	public final Ordering_termContext ordering_term() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1812); expr(0);
			setState(1815);
			_la = _input.LA(1);
			if (_la==COLLATE_) {
				{
				setState(1813); match(COLLATE_);
				setState(1814); collation_name();
				}
			}
	...
	public final Frame_leftContext frame_left() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(1826); expr(0);
				setState(1827); match(PRECEDING_);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(1829); expr(0);
				setState(1830); match(FOLLOWING_);
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(1832); match(CURRENT_);
				setState(1833); match(ROW_);
				}
				break;
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(1834); match(UNBOUNDED_);
				setState(1835); match(PRECEDING_);
				}
				break;
			}
		}
	...
	public final Frame_rightContext frame_right() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(1838); expr(0);
				setState(1839); match(PRECEDING_);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(1841); expr(0);
				setState(1842); match(FOLLOWING_);
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(1844); match(CURRENT_);
				setState(1845); match(ROW_);
				}
				break;
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(1846); match(UNBOUNDED_);
				setState(1847); match(FOLLOWING_);
				}
				break;
			}
		}
	...
	public final Frame_singleContext frame_single() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(1850); expr(0);
				setState(1851); match(PRECEDING_);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(1853); match(UNBOUNDED_);
				setState(1854); match(PRECEDING_);
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(1855); match(CURRENT_);
				setState(1856); match(ROW_);
				}
				break;
			}
		}
	...
	public final Window_functionContext window_function() throws RecognitionException {
		...
		try {
			...
			case LAST_VALUE_:
				...
				consume();
				setState(1860); match(OPEN_PAR);
				setState(1861); expr(0);
				setState(1862); match(CLOSE_PAR);
				setState(1863); match(OVER_);
				setState(1864); match(OPEN_PAR);
				setState(1866);
				_la = _input.LA(1);
				if (_la==PARTITION_) {
					{
					setState(1865); partition_by();
					}
				}

				setState(1868); order_by_expr_asc_desc();
				setState(1870);
				_la = _input.LA(1);
				if (((((_la - 128)) & ~0x3f) == 0 && ((1L << (_la - 128)) & ((1L << (ROWS_ - 128)) | (1L << (RANGE_ - 128)) | (1L << (GROUPS_ - 128)))) != 0)) {
					{
					setState(1869); frame_clause();
					}
				}

				setState(1872); match(CLOSE_PAR);
				}
				break;
			case CUME_DIST_:
			case PERCENT_RANK_:
				...
				consume();
				setState(1875); match(OPEN_PAR);
				setState(1876); match(CLOSE_PAR);
				setState(1877); match(OVER_);
				setState(1878); match(OPEN_PAR);
				setState(1880);
				_la = _input.LA(1);
				if (_la==PARTITION_) {
					{
					setState(1879); partition_by();
					}
				}
				...
				if (_la==ORDER_) {
					{
					setState(1882); order_by_expr();
					}
				}

				setState(1885); match(CLOSE_PAR);
				}
				break;
			case DENSE_RANK_:
			case RANK_:
			case ROW_NUMBER_:
				...
				consume();
				setState(1887); match(OPEN_PAR);
				setState(1888); match(CLOSE_PAR);
				setState(1889); match(OVER_);
				setState(1890); match(OPEN_PAR);
				setState(1892);
				_la = _input.LA(1);
				if (_la==PARTITION_) {
					{
					setState(1891); partition_by();
					}
				}

				setState(1894); order_by_expr_asc_desc();
				setState(1895); match(CLOSE_PAR);
				}
				break;
			case LAG_:
			case LEAD_:
				...
				consume();
				setState(1898); match(OPEN_PAR);
				setState(1899); expr(0);
				setState(1901);
				switch ( getInterpreter().adaptivePredict(_input,282,_ctx) ) {
				case 1:
					{
					setState(1900); offset();
					}
					break;
				}
				setState(1904);
				...
				if (_la==COMMA) {
					{
					setState(1903); default_value();
					}
				}

				setState(1906); match(CLOSE_PAR);
				setState(1907); match(OVER_);
				setState(1908); match(OPEN_PAR);
				setState(1910);
				_la = _input.LA(1);
				if (_la==PARTITION_) {
					{
					setState(1909); partition_by();
					}
				}

				setState(1912); order_by_expr_asc_desc();
				setState(1913); match(CLOSE_PAR);
				}
				break;
			case NTH_VALUE_:
				enterOuterAlt(_localctx, 5);
				{
				setState(1915); match(NTH_VALUE_);
				setState(1916); match(OPEN_PAR);
				setState(1917); expr(0);
				setState(1918); match(COMMA);
				setState(1919); signed_number();
				setState(1920); match(CLOSE_PAR);
				setState(1921); match(OVER_);
				setState(1922); match(OPEN_PAR);
				setState(1924);
				_la = _input.LA(1);
				if (_la==PARTITION_) {
					{
					setState(1923); partition_by();
					}
				}

				setState(1926); order_by_expr_asc_desc();
				setState(1928);
				_la = _input.LA(1);
				if (((((_la - 128)) & ~0x3f) == 0 && ((1L << (_la - 128)) & ((1L << (ROWS_ - 128)) | (1L << (RANGE_ - 128)) | (1L << (GROUPS_ - 128)))) != 0)) {
					{
					setState(1927); frame_clause();
					}
				}

				setState(1930); match(CLOSE_PAR);
				}
				break;
			case NTILE_:
				enterOuterAlt(_localctx, 6);
				{
				setState(1932); match(NTILE_);
				setState(1933); match(OPEN_PAR);
				setState(1934); expr(0);
				setState(1935); match(CLOSE_PAR);
				setState(1936); match(OVER_);
				setState(1937); match(OPEN_PAR);
				setState(1939);
				_la = _input.LA(1);
				if (_la==PARTITION_) {
					{
					setState(1938); partition_by();
					}
				}

				setState(1941); order_by_expr_asc_desc();
				setState(1942); match(CLOSE_PAR);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Partition_byContext partition_by() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(1952); match(PARTITION_);
			setState(1953); match(BY_);
			setState(1955); 
			_errHandler.sync(this);
			_alt = 1;
			do {
	...
	public final Order_by_exprContext order_by_expr() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1959); match(ORDER_);
			setState(1960); match(BY_);
			setState(1962); 
			_errHandler.sync(this);
			_la = _input.LA(1);
			do {
	...
	public final Order_by_expr_asc_descContext order_by_expr_asc_desc() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1966); match(ORDER_);
			setState(1967); match(BY_);
			setState(1968); expr_asc_desc();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Expr_asc_descContext expr_asc_desc() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1970); expr(0);
			setState(1972);
			_la = _input.LA(1);
			if (_la==ASC_ || _la==DESC_) {
				{
				setState(1971); asc_desc();
				}
			}
			...
			while (_la==COMMA) {
				{
				{
				setState(1974); match(COMMA);
				setState(1975); expr(0);
				setState(1977);
				_la = _input.LA(1);
				if (_la==ASC_ || _la==DESC_) {
					{
					setState(1976); asc_desc();
					}
				}
	...
	public final Error_messageContext error_message() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1990); match(STRING_LITERAL);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Module_argumentContext module_argument() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(1992); expr(0);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(1993); column_def();
				}
				break;
			}
		}
	...
	public final Any_nameContext any_name() throws RecognitionException {
		...
		try {
			...
			case IDENTIFIER:
				enterOuterAlt(_localctx, 1);
				{
				setState(2046); match(IDENTIFIER);
				}
				break;
			case ABORT_:
			case ACTION_:
			...
			case EXCLUDE_:
				enterOuterAlt(_localctx, 2);
				{
				setState(2047); keyword();
				}
				break;
			case STRING_LITERAL:
				enterOuterAlt(_localctx, 3);
				{
				setState(2048); match(STRING_LITERAL);
				}
				break;
			case OPEN_PAR:
				enterOuterAlt(_localctx, 4);
				{
				setState